...
Page({
    ...
    onReady() {
      console.log(app.globalData.userInfo)
        wx.setNavigationBarTitle({ title: '锐傲聊天室' });
    ...
    connect() {
        ...
        tunnel.on('connect', () => {this.popMessage(), console.log('信道已连接')});
        ...
        // tunnel.on('system', speak=>console.log("收到speak消息:" , speak));
     ...
     */
    popMessage() {
        this.updateMessages(messages => messages.pop());           // pop（） 方法删除数组最后一个数据，数组长度减一， 返回被删除的最后一个数
    },
